 ...
 * <p>The Game class is an {@link Activity}, just derrive from it and implement the {@link GameByMe#createStartScreen()} method,
 ...
 * of the device's screen. You can set a new target resolution at any time via {@link GameByMe#setOffscreenSurface(int, int)}.</p>
...
public abstract class Game extends Activity implements Runnable {
     ...
     * {@link GameByMe#createStartScreen()} method to fetch the first Screen to be active.
     */
...
//        
     ...
     * to the event lists returned in the {@link GameByMe#getKeyEvents()} and {@link GameByMe#getTouchEvents()}
     ...
     * returned in the {@link GameByMe#getKeyEvents()} and {@link GameByMe#getTouchEvents()}
