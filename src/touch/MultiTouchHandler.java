...
/**
 * This class implements touch event handling for Android 2.0 and above. It
 * supports multi-touch events as opposed to the {@link SingleTouchHandler}. It
 * implements the {@link TouchHandler} interface and reports the current state
...
public class MultiTouchHandler implements TouchHandler, OnTouchListener {
	...
	/**
	 * Constructor, setting this MultiTouchHandler as the
	 * {@link OnTouchListener} of the provided {@link View}. The
	 * touchEventBuffer argument is used to return {@link TouchEvent} instances
	 * to the user of this class. The {@link TouchEventPool} is used to obtain
	 * and recycle new {@link TouchEvent}.
	 * 
	 * @param view
	 *            the View to attach this handler to.
	 * @param touchEventBuffer
	 *            the buffer to write new touch events to.
	 * @param touchEventPool
	 *            the pool to create new TouchEvent instances with.
	 */
	public MultiTouchHandler(View view, List<TouchEvent> touchEventBuffer,
	...
	/**
	 * Implementation of the {@link OnTouchListener#onTouch} method. Decodes the
	 * touch event(s) stored in the MotionEvent argument, updates the internal
	 * members recording the current state of the touch screen (touchDown,
	 * touchX, touchY), and writes new {@link TouchEvent} instances to the touch
	 * event buffer provided by the user of this class. The method is
	 * synchronized on the touch event buffer as the buffer is filled on the UI
